    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        ...
        <div className="glass rounded-2xl p-8 max-w-xl w-full text-center">
          ...
          <Link to="/viewer" className="inline-flex items-center justify-center mt-6 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition text-white">
            Entrar na Sala de Jantar
          </Link>
        </div>

        <div className="mt-10 text-xs text-neutral-500">Pronto para deploy na Vercel</div>
      </div>
    </div>
  )
}